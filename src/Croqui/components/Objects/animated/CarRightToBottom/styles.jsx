...
const goRightToBottom = keyframes`
    0%{
...
export const MoveRightToBottom = styled.img`
    ...
    height: auto;
    position: relative;
    animation: ${ props => props.move === true ? goRightToBottom : props.move === 'pause' ? pause : zoom } ${props => props.move === true ? '5s infinite'  : '.5s ease-in-out' };
    transition: .2s;
    &:active{
        transform: scale(1.4);
    }
