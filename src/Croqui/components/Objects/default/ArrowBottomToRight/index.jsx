...
export default function ArrowBottomToRight(props){
	...
	const insertConfigModalSettings = () => {
        props.setPropsSettings({ type: 'arrow', title: 'Seta descendo vira à direita', image: arrowStartBottomToRight, object: props.arrowBottomToRight, setObject: props.setArrowBottomToRight});
