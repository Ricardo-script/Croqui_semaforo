...
export default function ArrowLeftToBottom(props){
	...
	const insertConfigModalSettings = () => {
        props.setPropsSettings({ type: 'arrow', title: 'Seta subindo vira a esquerda', image: arrowLeftToBottom, object: props.arrowLeftToBottom, setObject: props.setArrowLeftToBottom});
