...
const addCarRight = () => {
	...
	objects.push({ objeto: 'carRight', id: objects.length, top: 44.89, left: 48.22, grupo: '', anel: '', controlador: '', tamanho: 22, velocidade: 5, percurso: 30, angulo: 0 });
	setCarRight(objects);
}
...
const addCarLeft = () => {
	...
	objects.push({ objeto: 'carLeft', id: objects.length, top: 44.89, left: 48.22, grupo: '', anel: '', controlador: '', tamanho: 22, velocidade: 5, percurso: 30, angulo: 0 });
	setCarLeft(objects);
}
...
const addCarTopToRight = () => {
	...
	objects.push({ objeto: 'carTopToRight', id: objects.length, top: 44.89, left: 48.22, grupo: '', anel: '', controlador: '', tamanho: 22, velocidade: 3, percurso: 30, percursoFinal: 30, angulo: 90, anguloFinal: 360}); // ok
...
const addSemaforo = () => {
	...
	objects.push({ objeto: 'objSemaforo', id: objects.length, top: 44.89, left: 48.22, grupo: '', anel: '', controlador: '', tamanho: 14, velocidade: 5, percurso: 30, angulo: 0 });
...
const addSemaforoLeft = () => {
	...
	objects.push({ objeto: 'objSemaforoLeft', id: objects.length, top: 44.89, left: 48.22, grupo: '', anel: '', controlador: '', tamanho: 14, velocidade: 5, percurso: 30, angulo: 0 });
	setObjSemaforoLeft(objects);
}
const addSemaforoRight = () => {
	setRemove(false);
	const objects = [...objSemaforoRight];
	objects.push({ objeto: 'objSemaforoRight', id: objects.length, top: 44.89, left: 48.22, grupo: '', anel: '', controlador: '', tamanho: 14, velocidade: 5, percurso: 30, angulo: 0 });
...
const addWalkLeft = () => {
	...
	objects.push({ objeto: 'walkLeft', id: objects.length, top: 44.89, left: 48.22, grupo: '', anel: '', controlador: '', tamanho: 22, velocidade: 5, percurso: 12, angulo: 0 });
	setWalkLeft(objects);
}
...
const addWalkRight = () => {
	...
	objects.push({ objeto: 'walkRight', id: objects.length, top: 44.89, left: 48.22, grupo: '', anel: '', controlador: '', tamanho: 22, velocidade: 5, percurso: 12, angulo: 0 });
...
const addWalkBottom = () => {
	...
	objects.push({ objeto: 'walkBottom', id: objects.length, top: 44.89, left: 48.22, grupo: '', anel: '', controlador: '', tamanho: 22, velocidade: 5, percurso: 12, angulo: 0 });
...
const addWalkTop = () => {
	...
	objects.push({ objeto: 'walkTop', id: objects.length, top: 44.89, left: 48.22, grupo: '', anel: '', controlador: '', tamanho: 22, velocidade: 5, percurso: 12, angulo: 0 });
	setWalkTop(objects);
}
...
const addBotoeira = () => {
	...
	objects.push({ objeto: 'objBotoeira', id: objects.length, top: 44.89, left: 48.22, detector: '', anel: '', controlador: '', tamanho: 12, velocidade: 5, percurso: 30, angulo: 0 });
...
const addPlugin = () => {
	...
	objects.push({ objeto: 'objPlug', id: objects.length, top: 44.89, left: 48.22, grupo: '', anel: '', controlador: '', tamanho: 22, velocidade: 5, percurso: 30, angulo: 0 });
	setObjPlug(objects);
}
